...
import { Form, Button, Col, Row, Input, Select, Checkbox, Upload } from 'antd';
import { InboxOutlined } from '@ant-design/icons';

import { selectBootcampsLoading } from '../../redux/bootcamps/bootcamps.selectors.js';
import { createBootcampStartAsync } from '../../redux/bootcamps/bootcamps.actions.js';

const { Option } = Select;
const { TextArea } = Input;
const { Dragger } = Upload;

const CreateBootcamp = ({ createBootcampStartAsync, loading }) => {
				...
				<Col span={12}>
					<Form.Item
						...
						rules={[
							{
								required: true,
								message: 'Please choose an address from the list!'
							}
						]}>
						<>
							<AlgoliaPlaces
...
export default connect(mapStateToProps, { createBootcampStartAsync })(
	CreateBootcamp
);
